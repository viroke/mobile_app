    ...
    state = {
      ...
      render() {
        ...
        const  returnBack = () => {
           ...
           <View style={{marginRight:3, }}>
             <Text style={styles.post}>Joeboy just posted a new session</Text>
           </View>
           </View>
           </TouchableOpacity>
           ...
           padding:10,
            ...
            borderRadius: 3,  }} >
           <View style={{marginRight:3, }}>
           <SimpleLineIcons name="wallet" size={24} color="#24DEBE"
           ...
           padding:10,
            ...
            borderRadius: 3,  }} >
           <View style={{marginRight:3, }}>
           <Image source = {require('../assets/images/Ellipse7.png')}
             style={styles.image}/>
           </View>
