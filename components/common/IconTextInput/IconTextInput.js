                ...
                <View style={[rtl ? styles.justifyLeftInRow: styles.justifyRightInRow]}>
                    {
                        secureTextEntry &&
                            <View>
                                <TouchableOpacity onPress={() => onEyePress()} style={[styles.paddingH20]}>
                                    <FeatherIcon name={isSecure ? 'eye' : 'eye-off'} size={(iconStyle && iconStyle.size) || 16} color={(iconStyle && iconStyle.color) || '#2E2E2E'} />
                                </TouchableOpacity>
                            </View>
                    }
