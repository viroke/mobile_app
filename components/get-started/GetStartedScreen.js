                ...
                <View style={styles.container}>
                    ...
                    {this.props.AuthenticationStore.showPasswordInput ? (
                        <SimpleAnimation delay={200} duration={500} fade staticType="zoom">
                            ...
                            placeholderTextColor="#BDBDBD"
                            autoCapitalize="none"
                            value={this.props.AuthenticationStore.signinCredentials.password}
                    ...
                    <TouchableOpacity onPress={() => this.props.AuthenticationStore.authenticate()}>
                        <Button
                        ...
                        >
                            <Text style={{ color: "#ffff" }}>
                                { this.props.AuthenticationStore.showPasswordInput ? "LOGIN" : "NEXT"}
                            </Text>
                        </Button>
                    </TouchableOpacity>

                    <TouchableOpacity onPress={() => {console.log("ccccc")}}>
